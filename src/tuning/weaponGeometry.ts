...
// creeps in there at a heavily damped rate (see "Confirmed decisions"
// 15 in docs/PROGRESS.md), so a tower-centered radius smaller than
...
// this doesn't corner the upgrade design. See "Confirmed decisions" in
// docs/PROGRESS.md.
//
